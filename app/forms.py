...
class AdvertisementForm(FlaskForm):
    ...
    rent_lower = IntegerField('月租金下限', validators=[InputRequired("請輸入數字"), NumberRange(min=0)])
    rent_upper = IntegerField('月租金上限', validators=[InputRequired("請輸入數字"), NumberRange(min=0)])
